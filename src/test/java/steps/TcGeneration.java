...
// ArrayList<String> params = new ArrayList<String>(); // collected if needed
// elsewhere
// Map<String, String> b2bParamKeyValues = new HashMap<>();

// private static final String FILE_PATH =
// "src/test/java/resources/parametersNotHandled/parameters.txt";
// private static final String OUTPUT_CSV =
// "src/test/java/resources/GeneratedTestCases/modifiedTestCases.csv";

// private static boolean cleared = false; // ensures clearing happens only once
// private static final Set<String> writtenWords = new HashSet<>(); // track
// unique entries

// // -------- precompiled patterns for speed & clarity --------
// private static final Pattern CAMEL_SPLIT = Pattern.compile("([a-z])([A-Z])");
// private static final Pattern NON_ALNUM = Pattern.compile("[^a-z0-9]+");
// private static final Pattern LEN_TOKEN =
// Pattern.compile("^(\\d{2,4})(?:char|chars|character|characters)$");
// private static final Pattern PLACEHOLDER =
// Pattern.compile("^\\$\\{([^}]+)\\}$");
// private static final Pattern PLACEHOLDER_ANYWHERE =
// Pattern.compile("\\$\\{([^}]+)\\}");
...
// public ResolvedPair(String endpoint, String payload, Map<String, Object>
// resolved) {
...
// public void iterateEachRowAndRunTheTestCaseOfFile(String csvPath) throws
// Exception {
...
// CSVPrinter out = new CSVPrinter(new FileWriter(outFile, false),
// CSVFormat.DEFAULT)) {

// // Always write header because we just overwrote the file
// out.printRecord("HTTP Method", "test case name", "endpoint", "payload",
// "expected status");

// Iterable<CSVRecord> recs =
...
// try {
// Assert.assertEquals(response.statusCode(), expected, "Status code does not
// match");
...
// private String replaceParametersInJson(String json, Map<String, Object>
// resolved) {
// try {
// ObjectMapper mapper = new ObjectMapper();
...
// } catch (Exception e) {
// System.err.println("[WARN] JSON parse failed; falling back to text: " +
// e.getMessage());
// return replaceParametersInText(json, resolved);
// }
// }

// private JsonNode replaceJsonNodePlaceholders(JsonNode node, Map<String,
// Object> resolved) {
// ObjectMapper mapper = new ObjectMapper();
...
// private String replaceParametersInText(String input, Map<String, Object>
// resolved) {
// if (input == null)
// return null;
...
// public static final String PARTNER_USER_NAME_VALID =
// "partner_user_name_valid";
// public static final String PARTNER_USER_NAME_INVALID =
// "partner_user_name_invalid";
// public static final String PARTNER_USER_ID_VALID = "2134243234342324"; //
// adjust if you later fetch live
...
// public static final String char128 = generateString("B2B_API_Auto_", "A",
// 128);
// public static final String char127 = generateString("B2B_API_Auto_", "A",
// 127);
// public static final String char129 = generateString("B2B_API_Auto_", "A",
// 129);
// public static final String char254 = generateString("B2B_API_Auto_", "A",
// 254);
// public static final String char255 = generateString("B2B_API_Auto_", "A",
// 255);
// public static final String char256 = generateString("B2B_API_Auto_", "A",
// 256);
...
// // 2) Lowercase FIRST, then strip non-alphanumerics (pattern expects
// lowercase)
...
// boolean hasPartner = t.contains("partner") || t.contains("tradingpartner") ||
// t.contains("prtnr");
// boolean hasUser = t.contains("user") || t.contains("usr") ||
// t.contains("member");
// boolean hasName = t.contains("name") || t.contains("username") ||
// (t.contains("full") && t.contains("name"));
// boolean hasId = t.contains("id") || t.contains("userid") ||
// t.contains("user_id") || t.contains("identifier");
// boolean hasSpaces = t.contains("with") && t.contains("spaces");
// boolean isDuplicate = t.contains("another") || t.contains("duplicate") ||
// t.contains("exist")
// || t.contains("exists");
// boolean hasPassword = t.contains("password") || t.contains("pwd");
// boolean isValid = t.contains("valid") || t.contains("existing") ||
// t.contains("correct") || t.contains("right");
// boolean isInvalid = t.contains("invalid") || (t.contains("non") &&
// t.contains("existent")) ||
...
// // earlier this mapped to PARTNER_USER_ID_INVALID; use a valid username
// instead
// response = genericMethods.B2B_GET_Request(LoadEnvironment.tenant +
// "/b2b/partner-users");
// return response.jsonPath().getString("`partner-users`[0].user_name");
...
// // Writes a new line to the file (only if not duplicate), appending after
// first
// // write
